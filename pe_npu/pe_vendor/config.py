...
PE_VISION_CONFIG["PE-Core-L14-336-splitqkv"] = PEConfig(
    image_size=336,
    patch_size=14,
    width=1024,
    layers=24,
...
PE_TEXT_CONFIG["PE-Core-L14-336-splitqkv"] = PE_TEXT_CONFIG["PE-Core-L14-336"]
...
PE_VISION_CONFIG["PE-Core-T16-384-splitqkv"] = PEConfig(
    image_size=384,
    patch_size=16,
    width=192,
    layers=12,
...
PE_TEXT_CONFIG["PE-Core-T16-384-splitqkv"] = PE_TEXT_CONFIG["PE-Core-S16-384"]


PE_VISION_CONFIG["PE-Core-S16-384-splitqkv"] = PEConfig(
    image_size=384,
    patch_size=16,
    width=384,
    layers=12,
...
PE_TEXT_CONFIG["PE-Core-S16-384-splitqkv"] = PE_TEXT_CONFIG["PE-Core-S16-384"]
