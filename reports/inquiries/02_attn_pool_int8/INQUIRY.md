...
> 16bit override → full 모델도 NPU에서 cos 0.996. **→ [`../../vendor/mobilint_resolution_attn_pool.md`](../../vendor/mobilint_resolution_attn_pool.md)**
> (이 문서는 문의 당시 기록으로 보존.)
...
`reports/performance/NPU_pe_pipeline_e2e_hybrid.md`(attention pooling CPU 병목 실측).*
