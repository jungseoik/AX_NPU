#!/usr/bin/env python3
"""CLIP ViT-L/14-336 vision encoder -> MXQ. W4A16 + OPTQ.

77.80% top-1, cosine 0.973, 23.9 imgs/s.
(1000 ImageNet-1k val images, fp32 reference 78.00%; 8 Aries cores.)

OPTQ roughly triples compile time: ~150s -> ~1300s.

    python compile_w4a16.py --calib-src /path/to/jpegs
"""
...
def parse_args():
    ...
    a.output = a.output or HERE / f"{tag}_w4a16.mxq"
