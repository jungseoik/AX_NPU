...
| 06 | [`06_qwen3vl_prefill_optimization/`](06_qwen3vl_prefill_optimization/REPLY.md) | 2026-09 | Qwen3-VL-2B prefill 최적화 — 고해상도(dynamic RoPE)·신규 SDK 성능·코어모드·상위 NPU(MLA400) | **회신 수신** ★최신 — 신규 SDK에서 dynamic RoPE 지원 예정, 2B Batch16·필요수량은 미답변 |
