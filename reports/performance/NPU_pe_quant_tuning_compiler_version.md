...
| W4A8 + A16×5 | 0.8790 | 0.8560 | **0.9420** ※ | −0.023 | **+0.054** |

**튜닝 효과의 부호가 전 조합에서 뒤집힌다.**

> ※ **정정(2026-09-04)**: 최초 기록한 W4A8 1.2.0 값 **0.8932 는 A16 텐서 5개가 빠진 산출물**이었다.
> 측정에 쓴 임시 하네스가 A16 을 `--act16` 으로만 받는데 그걸 넘기지 않아 qk16 25개만 16bit였다.
> A16 을 정상 주입한 값은 **0.9420** 이며 벤더 제시값(0.905)을 오히려 넘어선다.
> 24조합 전수 실측: [`NPU_pe_quant_tuning_matrix_120.md`](NPU_pe_quant_tuning_matrix_120.md)
...
| W4A8 + A16×5 | +OPTQ+SWS | 188.0 MB | 0.9420 ※ | — | 19.94 img/s |
...
| W4A8+A16×5 +OPTQ+SWS | 0.905 | 0.8560 | **0.9420** ※ | **+0.037** |
