...
- 4개 코어모드 MXQ(동일 64프레임 calib + `--qk16`), median of 5, 실제 영상 프레임, 7×ARIES2.
- 정확도: 4개 모드 전부 원본 pth 대비 **cos 0.9957** (모드는 스케줄링만 다름, 출력 동일).
...
|---:|---:|---:|---:|
| 1 | 49/286/**336** | 36/119/**155** | 29/71/**100** |
| 7 | 541/287/**828** | 190/119/**309** | 222/71/**293** |
| 16 | 794/338/**1132** | 555/241/**796** | 380/211/**590** |
| 28 | 1037/369/**1406** | 554/246/**801** | 766/281/**1047** |
| 56 | 802/522/**1324** | 674/491/**1165** | 683/561/**1244** |
...
*작성 2026-06. full NPU(QKᵀ 16bit) 4모드 동일 calib, cos 0.9957, 7×ARIES2 실측.*
