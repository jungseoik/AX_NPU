...
- 측정: 7×ARIES async 분산, median of 5, 실제 영상 프레임.
...
| **full NPU (QKᵀ 16bit)** | **0.9957** (0.9945~0.9976) | **NPU** |
...
|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 98 | 286 | 7 | 391 | 287 | 385 | 1% |
| 4 | 392 | 287 | 19 | 698 | 287 | 679 | 3% |
| 7 | 714 | 288 | 28 | 1030 | 287 | 1001 | 3% |
| 8 | 370 | 312 | 29 | 711 | 311 | 681 | 4% |
| 16 | 758 | 343 | 55 | 1156 | 334 | 1092 | 6% |
| 28 | 932 | 374 | 89 | 1395 | 369 | 1301 | 7% |
| 42 | 858 | 445 | 138 | 1440 | 431 | 1288 | 11% |
| **56** | 773 | 536 | **187** | 1496 | 520 | **1294** | **13%** |

## 3. 핵심 결론

1. **head를 NPU에 올려도 추론시간 추가 ≈ 0.** `full N ≈ hyb T` (56ch: 520 ≈ 536ms).
...
2. **CPU attn_pool 단계가 통째로 사라진다.** hybrid의 Pool은 채널별 직렬 CPU 연산이라
   1→56ch에서 7→187ms로 증가하는데, full에서는 이 단계 자체가 없다(NPU가 카드별 병렬 처리).
3. **e2e 개선은 채널이 늘수록 커진다**: 저채널 1% → 최대배치(56ch) **13%**. 고채널일수록 CPU
...
> 참고: 본 측정의 CPU pool(56ch 187ms)은 이전 hybrid 단독 측정(`NPU_coremode_pipeline_e2e.md`,
...
*작성 2026-06. full MXQ = QKᵀ 16bit override, 원본 대비 cos 0.9957. 7×ARIES2 실측.*
