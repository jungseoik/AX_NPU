...
실행: python demo_track_yolo11_npu.py --mxq yolo11m_single.mxq --video in.mp4 --out out.mp4
...
def main():
    ...
    ap.add_argument("--mxq", required=True, help="YOLO MXQ (모델 바꾸려면 이것만)")
    ...
    det = YOLONPU(args.mxq, device_ids=dids, conf_thres=args.conf)
